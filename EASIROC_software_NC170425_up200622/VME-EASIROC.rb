...
class VmeEasiroc
    ...
    def sendSlowControl
        #$logger.info "\nVmeEasiroc::sendSlowControl: CALLED"
   ...
   def setTestChargePattern(setting)
    ...
    def reloadSetting
		...
		#if (registerFile=="0") then 
	#		input_registers = 'yaml/RegisterValue.yml'
    #    else # 64ch calibration
    #        input_registers = registerFile
    #        puts "VmeEasiroc::reloadSetting registerFile: #{input_registers}"
#		end
        ...
        @configLoader = ConfigLoader.new(
            ...
            #File.expand_path(input_registers, File.dirname(__FILE__)),
