        ...
        for(size_t i = 0; i < dataSize; ++i) {
		   ...
		   cerr << "event:"<<events<<"/scalerValues["<<ch<<"]:"<<scalerValues[ch] << endl; 
			...
			cerr << "	1K " << scalerValues[68] 
                    ...
                    //int scalerValsArrayIndex = events % 100; // 100 is this correct? because scalerValuesArray is [10][xx]  
                    int scalerValsArrayIndex = events % nAverage; // 100 is this correct? because scalerValuesArray is [10][xx]  
