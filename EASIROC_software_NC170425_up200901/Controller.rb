...
class CommandDispatcher
  ...
  DIRECT_COMMANDS.each do |command|
   ...
   def setHV(value)
      ...
      if diff.abs > 10.0 then
         puts "diff is #{diff.abs}! diff is too large! use stepSetHV; return"
         return
      end
  ...
  def drawScaler(filename="temp", dac="reg", *ch)
   ...
   def calibrateIndividual64
      ...
      for i in 0..63 do
         puts "calibration by test charge pulse for ch: #{i}"  

         fname0 = 'calib_chan' + i.to_s + '_qptn0'
         setTestPulseTo(i) # call slowcontrol  
         setTestPulsePtn(0)
         read(4000, fname0) # read calls slowcontrol in the end as default

         fname1 = 'calib_chan' + i.to_s + '_qptn1'
         setTestPulseTo(i)
         setTestPulsePtn(1)
         read(4000, fname1) # read calls slowcontrol in the end as default

         fname2 = 'calib_chan' + i.to_s + '_qptn2'
         setTestPulseTo(i)
         setTestPulsePtn(2)
         ...
         fname3 = 'sumcalib_chan' + i.to_s + '.root'
         fname4 = 'calib_chan' + i.to_s + '*.root'
   ...
   def xxx
      for i in 2..30 do
         ...
         setTestPulseTo(33)
         setTestPulsePtn(0)
         fname1 = 'calib_delay' + i.to_s + '_qptn0'
         sleep 0.5
         read(4000, fname1) # read calls slowcontrol in the end as default
         ...
         setTestPulseTo(33)
         setTestPulsePtn(1)
         fname2 = 'calib_delay' + i.to_s + '_qptn1'
         sleep 0.5
         read(4000, fname2) # read calls slowcontrol in the end as default
      end
	end
